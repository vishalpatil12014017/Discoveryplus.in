...
import { freeStream } from "../../../data/data";
function Free() {
  ...
  return (
    <Toolbar>
      <div style={{ padding: "4%", paddingTop: "1%", paddingBottom: "1%" }}>
        <h1 className="pt-3" style={{ fontSize: "20px", color: "white" }}>
          Stream For Free Now
          <Link
            to="/showall"
            className="float-end pt-0 hov"
            style={{
              color: "#838991",
              fontSize: "16px",
              textDecoration: "none",
            ...
            <div className="col col-6  g-3 col-lg-4 col-xl-3" key={e._id}>
              <Link to="/watch">
                ...
                >
                  ...
                  />
                  {e.prime ? (
                    <img className="top-left" src={pri} alt="" />
                  ) : null}
                  {!e.newstatus ? (
                    <button
                      className="btn-primary bottomCentered px-2"
                  ...
                  <div className="overlay1" style={{ padding: "1%" }}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-2">
                        <img
                          className="p-0 m-0 float-end like"
                          src={e.likestatus ? like2 : like1}
                          alt=""
                          onClick={() => {
                            handlecolor(e._id);
                          }}
